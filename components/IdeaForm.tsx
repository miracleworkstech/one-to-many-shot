  ...
  return (
    <form action={formAction} className="min-w-0 flex-1">
      ...
      <textarea
        ...
        className="field-sizing-content max-h-[5.75rem] w-full resize-none overflow-y-auto rounded-lg border border-transparent bg-transparent px-1 py-0.5 text-base leading-snug text-stone-900 placeholder:text-stone-600 hover:border-stone-300 focus:max-h-none focus:border-stone-300 focus:bg-white"
      />
